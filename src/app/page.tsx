  ...
  return (
    <main className="p-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 max-w-md">
        ...
        <input {...register('mainclass', { required: true, maxLength: 20 })} placeholder="Your class" className="p-2 border" />
        {errors.mainclass && <span className="text-red-600">Field required</span>}

        <input {...register('talent', { required: true, maxLength: 20 })} placeholder="Your talents" className="p-2 border" />
        {errors.talent && <span className="text-red-600">Field required</span>}

        <input {...register('gs', { required: true, valueAsNumber: true, maxLength: 20 })} type="number" placeholder="GearScore" className="p-2 border" />
